...
<div class="ct-bottom ct-pair"><article class="ct-card"><h2>Diárias acumuladas no período</h2><div id="ct-trend"></div><p class="ct-note">Mensalidades são integrais por competência e aparecem separadas abaixo. Orçamento não informado.</p></article><article class="ct-card"><h2>Diárias confirmadas — variação dia a dia</h2><div id="ct-daily" class="ct-daily-scroll"></div><p class="ct-note">Valor do dia acima do ponto; quantidade de contratos-rota diários com conclusão registrada acima da data. O valor é apurado uma vez por contrato principal e data. Arraste horizontalmente para ver todo o período.</p></article></div><div class="ct-bottom ct-pair"><article class="ct-card"><h2>Valor apurado por prestador</h2><div id="ct-suppliers"></div></article><article class="ct-card"><h2>Veículos com registro no período</h2><div id="ct-fleet"></div><p class="ct-note">Não representa disponibilidade ou estado de manutenção.</p></article></div>
